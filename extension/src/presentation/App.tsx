...
export function App() {
  ...
  if (!user) {
    return (
      <div className="tw-fixed tw-right-0 tw-top-0 tw-h-screen tw-w-72 tw-bg-background tw-flex tw-flex-col tw-font-sans" style={{ boxShadow: '-8px 0 30px rgba(0, 0, 0, 0.5), -2px 0 10px rgba(59, 130, 246, 0.1)' }}>
        ...
        <div className="tw-p-4 tw-text-center tw-border-t tw-border-border">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="tw-w-4 tw-h-4">
