  ...
  return (
    <div className="panel-header">
      <div className="panel-header-left">
        {showSettings ? (
          <>
            <button className="panel-header-btn" onClick={onToggleSettings} title={t('panel.title.back')}>
      ...
      <div className="panel-header-right">
        {!hideActions && !showSettings && (
          <button
            ...
            title={editMode ? t('panel.edit.done') : t('panel.edit.layout')}
          >
            {editMode ? (
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {!hideActions && !showSettings && (
          <button className="panel-header-btn" onClick={onToggleSettings} title={t('panel.settings')}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button className="panel-header-btn" onClick={signOut} title={t('common.signOut')}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
