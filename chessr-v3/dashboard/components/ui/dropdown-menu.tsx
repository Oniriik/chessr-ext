...
// Minimal shadcn-style wrapper around radix dropdown. Surfaces only what
// the dashboard uses today (Root / Trigger / Content / Item / Separator);
// extend when something asks for it.
